...
def get_data_high(message, answer: str):
    ...
    if answer == 'yes':
        for i in range(hotels_count):
            current_hotel_id = data_high['data']['body']['searchResults']['results'][i]['id']
            hotel_name = data_high['data']['body']['searchResults']['results'][i]['name']
            try:
                address = data_high['data']['body']['searchResults']['results'][i]['address']['streetAddress']
            except KeyError:
                address = data_high['data']['body']['searchResults']['results'][i]['address']['region']
            dist_to_center = (data_high['data']['body']['searchResults']['results'][i]['landmarks'][0]
            ['distance']).split(' ')[0]
            price = (data_high['data']['body']['searchResults']['results'][i]['ratePlan']['price']
            ["current"]).split(' ')[0]
            total_price = (data_high['data']['body']['searchResults']['results'][i]['ratePlan']['price']
